...
import { MyCarCardProps } from '../util/types'
    ...
    <section className="px-8">
      <div className="flex flex-row gap-4">
        ...
        <div className="flex flex-col gap-3 pr-3">
          <p className="w-20 truncate font-serif text-xl font-medium text-secondary-50 md:w-40 md:text-2xl">
            {carName}
          </p>
